    ...
    const fetchDiscoverData = async () => {
      ...
      try {
        ...
        switch (activeSection) {
          case 'feed':
            const feedData = await api.getContentFeed({ 
              type: 'all', 
              filter: 'recommended',
              limit: 10
            });
            setFeedContent(feedData.content || []);
            break;
          case 'events':
                      ...
                      {feedContent.length > 0 ? (
                        <div className="space-y-6">
                          {feedContent.map(content => (
                            <div key={content._id} className="pb-6 border-b border-gray-100 last:border-b-0">
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <Link to={`/${content.contentType || 'posts'}/${content._id}`} className="text-orange-500 hover:text-orange-600 text-sm font-medium">
                                  View Details
                                </Link>
                              </div>
                            </div>
                  ...
                  <div className="bg-white rounded-xl shadow-md overflow-hidden">
                    ...
                    <div className="p-6">
                      {events.length > 0 ? (
                        <div className="space-y-6">
                          {events.map(event => (
                            <div key={event._id} className="flex border border-gray-100 rounded-lg overflow-hidden shadow-sm hover:shadow transition-shadow">
                              ...
                              <div className="flex-1 p-4">
                                ...
                                <div className="flex items-center justify-between">
                                  ...
                                  <Link to={`/events/${event._id}`} className="text-orange-500 hover:text-orange-600 text-sm font-medium">
                                    View Event
                                  </Link>
                                </div>
                              </div>
